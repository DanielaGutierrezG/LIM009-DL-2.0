...
<section id = "x">`;
    if (datos[i].house === "Slytherin") {
      ...
      nuevo += `<div><img id="bandera" src="https://previews.123rf.com/images/ahasoft2000/ahasoft20001611/ahasoft2000161102930/66421405-excluir-marca-d-%C3%A1gua-de-carimbo-de-selo-de-borracha-x-cross-s%C3%ADmbolo-do-%C3%ADcone-dentro-do-quadro-do-c%C3%ADrculo-.jpg"></div>`;

    nuevo += `
<img id ="Imagenes" src="${datos[i].image}"></img></center></section>
...
${datos[i].species} </br> </br>`;
    ...
    if (datos[i].hogwartsStudent === true) {
      nuevo += `<div class=''><img id="icono" src="https://cdn.iconscout.com/icon/free/png-256/role-2-439291.png">Rol</div></br> ${"Estudiante"}</br></br>`;
    } else {
